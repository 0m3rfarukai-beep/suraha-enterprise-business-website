  ...
  return (
    <section className="bg-cream min-h-[70vh] flex items-center justify-center">
      <div className="max-w-[560px] mx-auto px-6 text-center py-32 md:py-40">
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center px-9 py-4 bg-gold text-navy-deep font-mono text-[11px] uppercase tracking-[0.2em] hover:bg-gold-light transition-colors duration-300 rounded-[2px] group"
        >
          Return Home
